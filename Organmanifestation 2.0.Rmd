...
```{r}
ggsave("sek2.pdf", sek2_plot, width = 25, height = 20, units = "cm")
```
...
ggsave("herzlunge2.pdf", herz_lunge_plot, width = 25 , height = 20, units = "cm")
```
...
ggsave("oeso_bewegung2.pdf", oeso_bewegung_plot, width = 25 , height = 20, units = "cm")
```
